declare module 'react-admin/lib/actions/dataActions' {
  import { Action } from "redux";
  import { DataProvider, mixed, IAdminListParams } from 'react-admin/lib/_types';
  ...
  export function crudDelete(
    ...
    previousData: any,
    basePath: string,
    redirectTo?: 'show' | 'edit' | 'list' | 'create' | null
  ): Action;
  ...
  export function changeListParams(resource: string, params: IAdminListParams): Action;
}
